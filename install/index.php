...
function subpage_title($txt) {
	...
	echo '<center><img src="'.$path_to_root.'/themes/default/images/quanlyviet.png" width="250" alt="Logo" >
		</center>';
	...
	display_heading(
		$page == 6 ? $txt :
			_('Quanlyviet Installation Wizard').'<br>'
...
if(!isset($_SESSION['inst_set']['inst_lang']))
