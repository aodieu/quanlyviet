...
if ($prepaid) {
	...
	label_row($_SESSION['Items']->payment_terms['days_before_due'] == -1 ? _('Left to be invoiced:') : _('Invoiced so far:'), price_format($_SESSION['Items']->get_trans_total()-max($_SESSION['Items']->prep_amount, $allocs)), 'class=label');
}
